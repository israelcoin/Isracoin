...
In order to support loading of multiple wallets in isracoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to isracoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into isracoin-qt, and as such, will require some minor modifications to provide hooks for
